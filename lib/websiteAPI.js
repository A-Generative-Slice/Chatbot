...
class WebsiteAPI {
    ...
    async searchProducts(query) {
        ...
        return this.makeRequest(`/api/products/search?query=${encodeURIComponent(query)}`, `search_${query.toLowerCase()}`);
    }
    ...
    async getProductsByCategory(categoryName) {
        return this.makeRequest(`/api/products/category/${encodeURIComponent(categoryName)}`, `category_${categoryName}`);
    }
