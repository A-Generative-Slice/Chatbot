...
`;
        ...
        let errorMsg = `🌸 I'm having a quick tea break! (Code: ${statusCode} - ${detailedMsg.substring(0, 80)}...). Please contact our team at +91 8610570490 for any assistance. ✨`;
        
        // Translate error message if needed
        if (language !== 'en-IN') {
            errorMsg = await translateResponse(errorMsg, language);
        }
