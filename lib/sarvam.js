...
7. ❌ NEVER invent YouTube channel links. Only use links from context.
8. ❌ NEVER mention "Rose Chemicals" website API.
...
`;
        ...
        const response = await axios.post('https://api.sarvam.ai/v1/chat/completions', {
            ...
            messages: messages,
            temperature: 0.5,
            max_tokens: 800, // INCREASED from 400 to 800 to prevent truncation
            max_tokens: 800
        }, {
            headers: {
