    ...
    try {
        const response = await axios.post('https://api.sarvam.ai/v1/chat/completions', {
            ...
            messages: [
                {
                    role: 'system',
                    content: `Translate the user's message into ${languageName}. Preserve all phone numbers, prices, URLs, product names, bullet points, and emphasis. Return only the translated text.`
                },
                {
                    role: 'user',
